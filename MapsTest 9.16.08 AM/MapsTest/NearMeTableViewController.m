...
#import "NearMeTableViewCell.h"



//

@interface NearMeTableViewController ()
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NearMeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"nearMeCell" forIndexPath:indexPath];
    
    cell.nameLabel2.hidden = YES;
    
    switch (self.selectedSegmentIndex) {
        case 1:
                cell.nameLabel.text = [self.sortedByClosestFloor1 objectAtIndex:indexPath.row];
            break;
        case 2:
...
- (void) segmentedControlChanged:(id)sender
{
    ...
    self.selectedSegmentIndex = self.segmentController.selectedSegmentIndex;
    NearMeTableViewCell *cell;
