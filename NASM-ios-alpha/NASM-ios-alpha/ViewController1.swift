...
class ViewController1: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate,MKMapViewDelegate,CLLocationManagerDelegate{
 ...
 //   @IBOutlet var scrollView: UIScrollView!
    ...
    @IBOutlet var TabBarMain: UITabBar!
    //random heights for collection view
    var heights = [200,175,175,200,175,175] as [CGFloat]
